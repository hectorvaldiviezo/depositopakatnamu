...
export default function NationwideMap() {
  ...
  return (
    <section className="py-16 bg-muted">
      <div className="container max-w-(--breakpoint-xl) rounded mx-auto py-16 px-4 bg-background relative shadow-lg">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 md:px-12">
          <div className="w-full lg:w-1/2">
            <div className="border-l-8 border-primary pl-4 mb-6">
              ...
              <p className="mb-4 text-base md:text-lg font-bold text-secondary">
            ...
            <p className="mb-6 text-secondary text-center font-bold font-roboto text-xl">
