...
export default function Companies() {
  return (
    <main className="flex flex-col items-center justify-center pb-20">
      <h1 className="text-2xl md:text-4xl font-bold mb-3 bg-linear-to-r from-navy to-danger bg-clip-text text-transparent">
        Nuestros socios en el camino
      </h1>
      <p className="text-muted-foreground px-4 text-xs md:text-base text-justify md:text-center max-w-(--breakpoint-md) mb-8">
